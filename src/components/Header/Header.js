    ...
    <header className='header'>
      <address>
        <ul className='social-media-links'>
          <li>
            <a href="https://wa.me/qr/MMWAREFAW4N4O1" target='_blank' rel="noreferrer">
              <img className='social-media-link-image' src={whatsApp} alt='WhatsApp'/>
            </a>
          </li>
          <li>
            <a href="https://www.instagram.com/m.sha.aa" target='_blank' rel="noreferrer">
              <img className='social-media-link-image' src={instagram} alt='Instagram'/>
            </a>
          </li>
          <li>
            <a href="https://www.facebook.com/mariiareznik" target='_blank' rel="noreferrer">
