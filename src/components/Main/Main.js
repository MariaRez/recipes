...
function Main() {
  return (
    <main className="main section">
      ...
      <h4 className="main-text dark-color-text medium-text upper-text">Давайте познакомимся</h4>
      <h3 className="main-title dark-color-text big-text">Всем привет! Меня зовут Мария и я фуд-блогер</h3>
